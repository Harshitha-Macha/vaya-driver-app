...
// Define Ride type if not already defined
type Ride = {
  id: string
  status: RideStatus
  [key: string]: any
...
export default function RidePage() {
  ...
  // Use the Ride type instead of any
  ...
  // If prev is null, return a default value (or handle it as needed)
  return {
    id: "", // provide a default or empty id, or you can handle it differently
    status: "inProgress",
  }
})
